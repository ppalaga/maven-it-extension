...
information of where to find the current Maven installation. This is needed to startthe Maven process
...
when you need to have a common cache (aka maven repository) for two or more test
